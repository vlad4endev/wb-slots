# 🚀 GitHub CI/CD для WB Slots

Полная система непрерывной интеграции и развертывания для автоматической сборки Docker образов.
...
│   └── error-handler.yml         # Обработка ошибок
├── ISSUE_TEMPLATE/
│   ├── bug_report.md             # Шаблон для багов
│   ├── feature_request.md        # Шаблон для фич
│   └── ci-cd-failure.md          # Шаблон для CI/CD ошибок
...
### 8. **error-handler.yml** - Обработка ошибок
**Назначение:** Автоматическое создание issue при ошибках

**Функции:**
- Создание issue при ошибках
- Комментирование коммитов
- Уведомления в Slack
- Закрытие issue при исправлении
