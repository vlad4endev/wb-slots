...
describe('RefactoredAutoBookingService', () => {
  ...
  beforeEach(() => {
    ...
    mockPuppeteer = require('puppeteer').default;
    ...
    require('../../lib/encryption').decrypt.mockReturnValue(JSON.stringify(mockDecryptedSessionData));
  });
...
describe('ChromePathFinder', () => {
  const { ChromePathFinder } = require('../../lib/services/refactored/auto-booking-service');
...
describe('SessionDataDecryptor', () => {
  const { SessionDataDecryptor } = require('../../lib/services/refactored/auto-booking-service');
  ...
  it('should decrypt extended format session data', () => {
    ...
    require('../../lib/encryption').decrypt.mockReturnValue(JSON.stringify(decryptedData));
  ...
  it('should convert simple format to extended format', () => {
    ...
    require('../../lib/encryption').decrypt.mockReturnValue(JSON.stringify(simpleData));
...
describe('AutoBookingService Integration', () => {
  ...
  it('should handle complete booking flow', async () => {
    ...
    mockPrisma.wBSession.findFirst.mockResolvedValue(mockWBSession);
    require('../../lib/encryption').decrypt.mockReturnValue(JSON.stringify(mockDecryptedData));
    mockPuppeteer.launch.mockResolvedValue(mockBrowser);
    mockBrowser.newPage.mockResolvedValue(mockPage);
    mockPage.goto.mockResolvedValue(undefined);
    mockPage.evaluate.mockResolvedValue(mockTokens);
